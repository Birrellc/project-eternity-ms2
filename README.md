...
_Frontend only - backend databases for reservation and the payment system for the online orders to be added as I progress during the course_.
...
This page is a simple form with an image behind it with another linear gradient over the top of it to not be so overpowering for the user, the form on this page will allow the user to contact the restaurant with any complaints, suggestions or questions they may have for the restaurant.
...
- The project will contain imagery throughout the website to advertise the business throughout.

---

### Structure

- The website is designed to allow viewers/users to quickly understand and view the information displayed without causing A distraction which may lead to failure to draw action from the user.
- The information throughout the website will be short and concise to allow the user to quickly navigate the area they wish to view without distraction while still providing the information they want.
...
- 3 User Interactive Forms With HTML Validation - Booking form\(modal\) & Contact form will send emails & Basket Form is used for checkout\(At present the form only submits to a form dump until my skills develop and I'm able to setup a database to store user payment data, logins, & shopping cart data). Both the Contact form & the Booking Form will have buttons that disable when submitted to prevent spam.
...
- Online Menu - An online menu has been setup with a JavaScript shopping cart \(items can be added to cart from menu page via buttons then quantity can be adjusted in the shopping cart modal with the total price being calculated but due to my lack of skillset the there is no paywall / checkout feature functioning yet but will be added as my skills improve\).
...
- The ability to update and alternate menu with ease.
...
**_Note: Github has changed master branch names to main - Currently at the time of this project the branch name is still referred to as "master"._**
...
- Select the clone option at the top right of the Repository.
- From here you will be able to download the code and open it locally on your PC with your own IDE.
